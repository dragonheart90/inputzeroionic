...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppHomeHomePageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-header>\n  <ion-toolbar>\n    <ion-title>Users</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-card *ngFor=\"let category of rows\">\n    <!-- <ion-card-header>\n      <img src=\"{{category.avatar}}\"/>\n    </ion-card-header> -->\n    <ion-card-content>\n    <ion-item> \n      <span style=\"float: left;\"><img src=\"{{category.avatar}}\" /></span> &nbsp;&nbsp;&nbsp;\n      <span style=\"float: right;\"><ion-label style=\"float: right;\">Name: {{category.first_name}} {{category.last_name}}<br>Email id: {{category.email}}</ion-label></span>\n      <!-- <ion-button fill=\"outline\" slot=\"end\">View</ion-button> -->\n    </ion-item>\n    </ion-card-content>\n    </ion-card>\n</ion-content>\n";
    /***/
  },
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(httpa, http, loadingController, rest, storage) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    ...
                    this.httpa.get(this.baseurl + 'users', {}, {
                      'Content-Type': 'application/json'
                    }).then(function (response) {
                      console.log(response.data);
                      _this.data2 = JSON.parse(response.data);
                      console.log(_this.data2.data);
                      _this.rows = _this.data2.data;
                      _this.limit = _this.data2.per_page;
                    });
  ...
  function srcAppRestServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RestService = function RestService() {
      _classCallCheck(this, RestService);

      this.URL = '';
      this.apiURL = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["SERVER_URL"];
      this.apiURLs = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["SERVER_URL1"];
    };
